...
exports.InsertRegistersIntoDB = void 0;
const uuid_1 = require("uuid");
async function InsertRegistersIntoDB(doc, Registers, tx) {
    let query = '';
    ...
    for (const rec of Registers.Accumulation) {
        if (rec.company === '9F00DDE0-F043-11E9-9115-B72821305A00' &&
            (rec.type === 'Register.Accumulation.PL' || rec.type === 'Register.Accumulation.Balance'))
            continue; // HOLDING
        const date = rec.date ? rec.date : doc.date;
        const data = Object.assign(Object.assign(Object.assign({}, rec), rec['data']), { company: rec.company || doc.company, document: doc.id });
        delete data.type;
        delete data.company;
        delete data.kind;
      ...
      VALUES ('${rec.id || uuid_1.v1().toUpperCase()}', '${rec.parent}', ${rec.calculated ? 1 : 0}, ${rec.kind ? 1 : 0}, '${new Date(date).toJSON()}', N'${rec.type}' , N'${rec.company || doc.company}',
...
exports.InsertRegistersIntoDB = InsertRegistersIntoDB;
//# sourceMappingURL=InsertRegistersIntoDB.js.map