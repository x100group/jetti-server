...
;
GO
CREATE UNIQUE CLUSTERED INDEX [Document.CashRequest.v] ON [Document.CashRequest.v](id);CREATE NONCLUSTERED INDEX[Document.CashRequest.v.PayDay] ON [Document.CashRequest.v]([PayDay]) INCLUDE([company]);
...
CREATE OR ALTER VIEW dbo.[Document.UserSettings.v] WITH SCHEMABINDING AS
      ...
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeCompanys"')), 0) [ExcludeCompanys]
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeDepartments"')), 0) [ExcludeDepartments]
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeStorehouse"')), 0) [ExcludeStorehouse]
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeCashRegisters"')), 0) [ExcludeCashRegisters]
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeBankAccounts"')), 0) [ExcludeBankAccounts]
      , ISNULL(TRY_CONVERT(BIT, JSON_VALUE(doc,N'$."ExcludeOperationGroups"')), 0) [ExcludeOperationGroups]
      FROM dbo.[Documents]
